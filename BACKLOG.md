...
- [x] **Status:** Resolved — emitDegradeEvent() implemented in analytics.js + tierEnforcement.js (Cycle 11)
...
- [x] **Status:** Deferred — operations/infrastructure concern — out of scope for current sprint
...
- [x] **Status:** Deferred — CI/CD concern — out of scope for current sprint
...
- [x] **Status:** Deferred — CI/CD/release management concern — out of scope for current sprint
...
- [x] **Status:** Resolved — Health endpoint already exposes hasResend: !!env?.RESEND_API_KEY in ?full=1 response (Cycle 11)
- **Severity:** High
...
- [x] **Status:** Resolved — gate-data.js created with all 64 I Ching hexagram names (Cycle 11)
...
- [x] **Status:** Resolved — Birth data banner + clearBirthData() added to restoreBirthData() (Cycle 11)
- **Severity:** Critical (UX)
...
- [x] **Status:** Deferred — P3 architecture — IA restructuring across all nav surfaces
- **Severity:** Critical (UX)
...
- [x] **Status:** Resolved — gate-data.js loader created (Cycle 11)
...
- [x] **Status:** Deferred — P3 architecture — module extraction; functional but unoptimized
- **Severity:** High (Performance)
- **Files:** `frontend/index.html` (inline scripts)
...
- [x] **Status:** Deferred — P3 architecture — CSS extraction; functional but unoptimized
- **Severity:** High (Maintainability)
...
- [x] **Status:** Deferred — P3 — token refactor; functional
- **Severity:** High (Consistency)
- **Files:** `frontend/index.html` (inline styles)
...
- [x] **Status:** Deferred — P3 — typography token refactor; functional
...
- [x] **Status:** Resolved — MOBILE_TAB_GROUPS updated with drawer-only tab mapping to more nav group (Cycle 11)
- **Severity:** Medium (UX)
...
- [x] **Status:** Resolved — Twitter intent + copy-to-clipboard share buttons added to renderChart() (Cycle 11)
...
- [x] **Status:** Resolved — showSkeleton() utility added; all loading states unified (Cycle 11)
...
- [x] **Status:** Resolved — ERROR_COPY map + showError() function added; actionable error CTAs throughout (Cycle 11)
...
- [x] **Status:** Deferred — P3 — KV-backed per-tier rate limiter; global rate limiting already in place
...
- [x] **Status:** Deferred — P3 — operational config; minimal impact at current traffic scale
...
- [x] **Status:** Deferred — P3 architecture — frontend+worker deploy as unit; low risk at current scale
