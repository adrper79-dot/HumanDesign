...
window.GATE_EXPLANATIONS = {
  ...
  34: 'You carry one of the most powerful energies in human design — a raw, responsive force that moves mountains when expressed in response to what life brings. Acting before you feel the call turns this power against you.',
  ...
  41: 'You carry the spark that starts every new cycle — a pressure of imagination and desire for new experience. All creativity in the Human Design chart begins with you. Choose which desires are worth pursuing; you can\'t chase them all.',
