# Full Audit — 2026-03-19
**Mode:** MAINTENANCE | **Full AI Audit:** No
**Tests:** 983/991 passing
**Browser Smoke:** skipped — Missing E2E_TEST_EMAIL/E2E_TEST_PASSWORD for browser smoke.
...
```json
{
  ...
  "results": [
    ...
    },
    {
      ...
      "code": 1,
      "stdout": "",
      "stderr": "rectify error message incorrect: Validation failed\n"
    },
    {
      "name": "browser smoke",
      "ok": true,
...
- `/workers/src/handlers/auth.js:325` [unstructured-log] — console.warn('[auth] Referral capture failed (non-fatal):', err.message);
...
---
*Generated by Prime Self Audit Bot on 2026-03-19T21:52:20.306Z*
